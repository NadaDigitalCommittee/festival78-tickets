...
export const Terms: FC = () => (
  <div className={`${styles.content} [&>] py-12`}>
    <h1>第78回灘校文化祭抽選システム利用規約とプライバシーポリシー</h1>
    <h2>利用規約</h2>
    <p>
      灘校生徒会（以下、「生徒会」）が提供する第78回灘校文化祭抽選システム（以下、「本システム」）を利用する方は、この利用規約（以下、「本規約」）をよくお読みの上、同意される場合のみ利用することができます。
    </p>
