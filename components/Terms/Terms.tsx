...
export const Terms: FC = () => (
  <div className={`${styles.content} py-12`}>
    ...
    <h3>第4条（免責事項）</h3>
    <p>本システムが利用者の登録に対し抽選を行い不当な結果を出す等のトラブルを引き起こしても、生徒会は責任を負いません。</p>
    <p>ただし、以下の場合については処置を行います。</p>
    <ul>
      <li>本システムがダウンした場合</li>
      <li>本システムに抽選の継続が困難であると判断される程重大なバグが発見された場合</li>
    </ul>
    ...
    <ul>
      <li>「抽選企画」は本来抽選券システムでの抽選が必要であったはずの企画のことを指します。</li>
      <li>抽選企画の各会場の責任者が定員分の数字が書かれた紙を用意し、来場した方に渡します。</li>
    ...
    <p>生徒会は以下の場合を除いて、利用者の同意のない限り個人情報を第三者に提供することはありません。 </p>
    <ul>
      <li>法令に基づく場合</li>
